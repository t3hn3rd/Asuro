{
    ...
    bindings used by proc.mgr.pas and arch.x86.proc.sched.pas.
...
const
    { 8 KB per-process core.version stack }
...
type
    ...
    TProcessContext = record
        ...
        { Per-process file descriptor table (PFDTable from driver.storage.fdtable.pas) }
        FDTable     : void;
