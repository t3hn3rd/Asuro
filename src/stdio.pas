...
uses
    lmemorymanager, strings, util, tracer;
...
begin
    ...
    bufWriteStrLn(stdout_buf, asuro.VERSION);
    bufWriteStr(stdout_buf, '  Compiled on: ');
    bufWriteStr(stdout_buf, asuro.COMPILE_DATE);
    bufWriteStr(stdout_buf, ' ');
    bufWriteStrLn(stdout_buf, asuro.COMPILE_TIME);
    bufWriteStrLn(stdout_buf, '  Compiled With: ');
    bufWriteStr(stdout_buf, '    NASM - Version: ');
    bufWriteStrLn(stdout_buf, asuro.NASM_VERSION);
    bufWriteStr(stdout_buf, '    FPC  - Version: ');
    bufWriteStrLn(stdout_buf, asuro.FPC_VERSION);
    bufWriteStr(stdout_buf, '    MAKE - Version: ');
    bufWriteStrLn(stdout_buf, asuro.MAKE_VERSION);
    bufWriteStr(stdout_buf, '  ');
    bufWriteInt(stdout_buf, asuro.LINE_COUNT);
    bufWriteStr(stdout_buf, ' lines, across ');
    bufWriteInt(stdout_buf, asuro.FILE_COUNT);
    bufWriteStrLn(stdout_buf, ' files.');
    bufWriteStr(stdout_buf, '  Baked Drivers: ');
    bufWriteIntLn(stdout_buf, asuro.DRIVER_COUNT);
    bufWriteStr(stdout_buf, '  Checksum: ');
    bufWriteStrLn(stdout_buf, asuro.CHECKSUM);
end;
...
begin
    ...
    syslog.logln('STDIO', 'Initialized.');
end;
