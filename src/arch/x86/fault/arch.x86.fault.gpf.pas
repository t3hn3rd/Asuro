...
{ 
	Fault->arch.x86.fault.gpf - General Protection Fault.
	
	@author(Kieron Morris <kjm@kieronmorris.me>)
}
unit arch.x86.fault.gpf;
...
procedure register();
begin
    arch.x86.isr.mgr.registerISR(13, @Main);
    //memset(uint32(@Hooks[0]), 0, sizeof(pp_hook_method)*MAX_HOOKS);
    //arch.x86.idt.set_gate(13, uint32(@Main), $08, ISR_RING_0);
end;
