...
{ 
	Driver->Timer->arch.x86.isr.tmr1 - 1024/s Timer Driver.
	
	@author(Kieron Morris <kjm@kieronmorris.me>)
}
unit arch.x86.isr.tmr1;
...
begin
    if not registered then begin
        ...
        arch.x86.isr.mgr.registerISR(40, @Main);
        //arch.x86.idt.set_gate(40, uint32(@Main), $08, ISR_RING_0);
        Registered:= true;
    end;
end;
