...
procedure init() begin
    push_trace('driver.storage.fs.asfs.init()');
    filesystem.sName:= 'driver.storage.fs.asfs'; 
...
begin
    ...
    driver.storage.mgr.storage_write(disk, start + 1, 1, buffer);
