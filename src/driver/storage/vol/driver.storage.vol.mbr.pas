...
procedure set_bootable(partition_table : PPartition_table);
begin
    push_trace('driver.storage.vol.mbr.set_bootable');
...
function get_bootable(partition_table : PPartition_table) : boolean;
begin
    push_trace('driver.storage.vol.mbr.get_bootable');
...
procedure setup_partition(partition_table : PPartition_table; address : uint32; sectorSize : uint32);
begin
    push_trace('driver.storage.vol.mbr.setup_partition');
    ...
    push_trace('driver.storage.vol.mbr.setup_partition.end');
end;
