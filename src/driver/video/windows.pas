{
    Driver->Video->Windows - LVGL-based windowing system.

    Provides managed, draggable, resizable, collapsible windows
...
type
    ...
    TWinRecord = record
        ...
        dragging     : boolean;
        resizing     : boolean;
        drag_ox      : sint32;    { mouse offset from frame origin when drag started }
        drag_oy      : sint32;
...
begin
    ...
    tracer.push_trace('windows.create');
...
begin
    ...
    tracer.push_trace('windows.destroy');
...
{ ============================================================
  Public: get total number of open windows
  ============================================================ }
function getWindowCount: uint32;
var
    i: uint32;
